...
export const tableSetups: TableSetup[] = [
  {
    id: "elegant-white",
    name: "Elegant White",
    ...
    napkinId: "napkin-white-fold",
    napkinRingId: "ring-gold-minimal",
    tableclothId: "tablecloth-white",
    previewTone: "from-stone-100 via-neutral-200 to-stone-400",
  },
  {
    id: "black-gold",
    name: "Black & Gold",
    ...
    cutleryId: "cutlery-polished-gold",
    glassId: "glass-crystal-clear",
    napkinId: "napkin-black-fold",
    napkinRingId: "ring-gold-minimal",
    tableclothId: "tablecloth-black",
    previewTone: "from-neutral-950 via-zinc-900 to-yellow-900",
  },
  {
    id: "classic",
    name: "Classic",
    ...
    napkinRingId: "ring-gold-minimal",
    tableclothId: "tablecloth-white",
    previewTone: "from-zinc-200 via-stone-300 to-neutral-500",
  },
];
